        ...
        <div class="w-64 bg-purple-800 text-white">
            ...
            <div class="mt-6">
                <div class="space-y-1">
                    ...
                    <a href="<?php echo e(route('Lab.upload_reports')); ?>"
                       class="flex items-center space-x-2 px-4 py-2 <?php echo e(request()->routeIs('Lab.upload_reports') ? 'bg-purple-900' : 'hover:bg-purple-700'); ?>">
                       <img src="<?php echo e(asset('images/medical-reports.png')); ?>" alt="report" style="width: 20px;" >
                       
                        <span>Upload Reports</span>
                    </a>
                    <a href="<?php echo e(route('Lab.upload_bills')); ?>"
                       class="flex items-center space-x-2 px-4 py-2 <?php echo e(request()->routeIs('Lab.upload_bills') ? 'bg-purple-900' : 'hover:bg-purple-700'); ?>">
...
<?php /**PATH D:\Xampp\htdocs\HealthBridge\resources\views/layouts/lab.blade.php ENDPATH**/ ?>